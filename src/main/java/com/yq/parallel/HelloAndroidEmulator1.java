...
/*
 在windows平台上执行
 */
public class HelloAndroidEmulator1 {
    ...
    public void setUp(String appiumServerPort,String udid) throws Exception {
        ...
        capabilities.setCapability("appPackage", "com.Vcredit.manage.pre");
...
//        driver = new AndroidDriver<WebElement>(new URL("http://127.0.0.1:"+appiumServerPort+"/wd/hub"), capabilities);
     ...
     */
    @Test
    public void yqLoginTest1() throws InterruptedException {
        Thread.sleep(3000);
