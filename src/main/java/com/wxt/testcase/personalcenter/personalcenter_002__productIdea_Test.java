 ...
 *
 */
public class personalcenter_002__productIdea_Test extends BaseTestcase {
    LoggerControler log = LoggerControler.getLogger(personalcenter_002__productIdea_Test.class);


    @Test
    @Parameters({"zyf_account","zyf_password"})
    public void createProductIdea(String account, String password) {
//        String account = "00100303623";//赵勇飞
//        String password = "654321";


        String productIdea = "创建产品意见autoTest"+DateFormate.format(DateFormate.DEFAULT_DATE_FORMAT);//产品的问题和意见
...
//        System.out.println("源码：\n"+driver.getPageSource());
        ...
        myDriver.findElement(MobileBy.AccessibilityId("请简要描述你的问题和意见")).sendKeys(productIdea);
        driver.hideKeyboard();
...
//        myDriver.findElement(MobileBy.AccessibilityId("提 交")).click();
        ...
        //后台处理产品意见或需求的回复
        backReply(productIdea,productIdeaReply);
